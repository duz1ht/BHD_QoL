...
The DLL also installs one dynamic-resolution cursor and viewport hook:

| Address | Original | Patched | Function | Purpose |
| --- | --- | --- | --- | --- |
| `004623D2` | `MOV DWORD PTR [EBP + -0x8],0x27F` | `JMP 005E4912` | `InitializeInGameSystems()` | Change ClipCursor logic to include dynamic resolutions. |
