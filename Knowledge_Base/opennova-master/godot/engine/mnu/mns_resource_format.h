...
// Loads NovaLogic .mns menu stylesheets into MnsStyleSheet.
class ResourceFormatLoaderMNS : public ResourceFormatLoader {
	GDCLASS(ResourceFormatLoaderMNS, ResourceFormatLoader)
...
class ResourceFormatSaverMNS : public ResourceFormatSaver {
	GDCLASS(ResourceFormatSaverMNS, ResourceFormatSaver)
