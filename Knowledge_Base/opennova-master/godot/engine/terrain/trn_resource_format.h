...
class ResourceFormatLoaderTRN : public ResourceFormatLoader {
	GDCLASS(ResourceFormatLoaderTRN, ResourceFormatLoader)
...
class ResourceFormatSaverTRN : public ResourceFormatSaver {
	GDCLASS(ResourceFormatSaverTRN, ResourceFormatSaver)
