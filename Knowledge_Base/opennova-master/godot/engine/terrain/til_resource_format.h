...
class ResourceFormatLoaderTIL : public ResourceFormatLoader {
	GDCLASS(ResourceFormatLoaderTIL, ResourceFormatLoader)
...
class ResourceFormatSaverTIL : public ResourceFormatSaver {
	GDCLASS(ResourceFormatSaverTIL, ResourceFormatSaver)
