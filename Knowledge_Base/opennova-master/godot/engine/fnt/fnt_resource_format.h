#ifndef OPENNOVA_FNT_RESOURCE_FORMAT_H
#define OPENNOVA_FNT_RESOURCE_FORMAT_H
...
class ResourceFormatLoaderFNT : public ResourceFormatLoader {
	GDCLASS(ResourceFormatLoaderFNT, ResourceFormatLoader)
...
class ResourceFormatSaverFNT : public ResourceFormatSaver {
	GDCLASS(ResourceFormatSaverFNT, ResourceFormatSaver)
...
#endif // OPENNOVA_FNT_RESOURCE_FORMAT_H
